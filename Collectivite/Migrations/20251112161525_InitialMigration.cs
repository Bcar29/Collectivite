        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rccm = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Nom = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroContrat = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DateSignature = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Motifs = table.Column<string>(type: "text", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MontantOrdre = table.Column<double>(type: "double", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditsBudgetaires = table.Column<double>(type: "double", nullable: false),
                    EngagementsAnterieurs = table.Column<double>(type: "double", nullable: false),
                    MontantEngagement = table.Column<double>(type: "double", nullable: false),
                    FichierJoin = table.Column<byte[]>(type: "longblob", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngagementId = table.Column<int>(type: "int", nullable: false),
                    MontantBrut = table.Column<double>(type: "double", nullable: false),
                    Rts = table.Column<double>(type: "double", nullable: false),
                    AutresPrecomptes = table.Column<double>(type: "double", nullable: false),
                    MontantNet = table.Column<double>(type: "double", nullable: false),
                    ...
                    Objet = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FichierJoin = table.Column<byte[]>(type: "longblob", nullable: true),
                    Motif = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
